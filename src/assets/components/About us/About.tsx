        ...
        <div className="aboutDescription">
          ...
          <div className="about-info">
            ...
            >
              ...
              and I found ReactJS for the front-end and I enjoyed using it to create websites that are responsive, scalable, and user-friendly. Aside from coding, I also enjoy designing and creating website prototypes using these tools, Figma, Canva, and Adobe.
